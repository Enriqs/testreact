...
<form name="frmAdd" method="post" action="" id="frmAdd"
    ...
    <div>
        <label style="padding-top: 20px;">home_id </label> <span
            ...
            value="<?php echo $result[0]["home_id "]; ?>" readonly>
    </div>
    <div>
    ...
    <div>
        <label style="padding-top: 20px;">phone_number</label> <span
            ...
            value="<?php echo $result[0]["phone_number"]; ?>">
    </div>
    <div>
        <label style="padding-top: 20px;">score</label> <span
            ...
            value="<?php echo $result[0]["score"]; ?>">
    </div>
    <div>
        <label>price</label> <span id="price-info"
            class="info"></span><br /> <input type="text"
            name="price" id="price" class="demoInputBox"
            value="<?php echo $result[0]["price"]; ?>">
    </div>
    <div>
        <label>location1</label> <span id="location1-info" class="info"></span><br />
        <input type="text" name="location1" id="location1" class="demoInputBox"
            value="<?php echo $result[0]["location1"]; ?>">
    </div>
    <div>
        <label>location2</label> <span id="location2-info" class="info"></span><br />
        <input type="text" name="location2" id="location2" class="demoInputBox"
            value="<?php echo $result[0]["location2"]; ?>">
    </div>
    <div>
        <label>zip_number</label> <span id="zip_number-info" class="info"></span><br />
        <input type="text" name="zip_number" id="zip_number" class="demoInputBox"
            value="<?php echo $result[0]["location2"]; ?>">
    </div>
    <div>
        <label>amenities</label> <span id="amenities-info" class="info"></span><br />
        <input type="text" name="amenities" id="amenities" class="demoInputBox"
            value="<?php echo $result[0]["amenities"]; ?>">
    </div>
    <div>
        <label>start_date</label> <span id="start_date-info" class="info"></span><br />
        <input type="text" name="start_date" id="start_date" class="demoInputBox"
            value="<?php echo $result[0]["start_date"]; ?>">
    </div>
    <div>
        <label>introduction</label> <span id="introduction-info" class="info"></span><br />
        <input type="text" name="introduction" id="introduction" class="demoInputBox"
            value="<?php echo $result[0]["introduction"]; ?>">
    </div>
    <div>
        <label>meal_id </label> <span id="meal_id-info" class="info"></span><br />
        <input type="text" name="meal_id " id="meal_id " class="demoInputBox"
            value="<?php echo $result[0]["meal_id "]; ?>">
    </div>
    <div>
